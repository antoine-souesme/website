...
const faqItems = [
    {
        ...
        answer: "Un site vitrine demande environ 2 à 3 jours de développement, soit environ 900 à 1 350 € sur la base de 450 € par jour.",
    },
    {
        question:
            "Comment est calculé le prix d'un site ou d'un logiciel sur mesure ?",
        answer: "Je détaille votre besoin en fonctionnalités, j'estime le nombre de jours nécessaires, puis j'applique mon tarif de 450 € par jour. Vous recevez un devis précis avant de démarrer.",
    },
    {
        question: "Que comprend la maintenance à partir de 29,90 € par mois ?",
        answer: "Les petites corrections et les ajustements du quotidien, comme la modification d'un texte ou d'une image. Les nouvelles fonctionnalités font l'objet d'un devis séparé.",
    },
    {
        question: "Combien de temps pour recevoir un devis ?",
        answer: "Je m'engage à un premier retour sous 24h ouvrées pour cadrer votre besoin et vous proposer la suite.",
    },
];
...
export const metadata: Metadata = buildPageMetadata({
    ...
    description:
        "Tarifs d'un développeur freelance en Bretagne : 450 € par jour, site vitrine d'environ 900 à 1 350 €, logiciel métier sur devis, maintenance à partir de 29,90 € par mois.",
    path,
    keywords: [
                ...
                <section className="pt-40 pb-20 px-6 bg-sand-100">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <p className="text-lg md:text-xl text-ink-700 leading-relaxed max-w-3xl">
                            Mon tarif est de 450 € par jour de développement.
                            Chaque projet est chiffré en nombre de jours, pour
                            que vous sachiez exactement ce que vous payez.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-20 px-6 bg-sand-50 border-y border-ink-900/5">
                    <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-px bg-ink-900/10 border border-ink-900/10 rounded-2xl overflow-hidden">
                        {offers.map((offer) => (
                            ...
                            >
                                <p className="eyebrow text-sand-500 mb-6">
                                    {offer.eyebrow}
                                </p>
                                {offer.unit && (
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-10">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl serif-h2">
                                Vos <span className="serif-em">questions</span>{" "}
                                sur les prix.
                            </h2>
                        </div>
                        ...
                        <div className="mt-16 grid md:grid-cols-[1fr_auto] items-center gap-8 paper rounded-2xl p-10">
                            <div>
                                ...
                                <p className="text-ink-700 leading-relaxed max-w-2xl">
                                    ...
                                    sous 24h ouvrées avec une première
                                    estimation.
                                </p>
                            </div>
                            <Link
